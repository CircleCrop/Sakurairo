...
?>
 ...
                        <?php endif; ?>
                        ...
                        <?php endif; ?>
                        <br>
						<a href="https://github.com/mirai-mamori/Sakurairo" rel="noopener" target="_blank" id="site-info" >Theme Sakurairo</a> <a href="https://github.com/CircleCrop/Sakurairo" rel="noopener" target="_blank" id="site-info-modified" >Modified Version</a>.
					</span>
			</div>
		</div>
    <!-- .site-info -->
