  ...
  Sakurairo_CSF::createSection($prefix, array(
    ...
    'fields' => array(
      ...
      array(
        'id' => 'footer_info_2',
        'type' => 'textarea',
        'title' => __('页尾信息 2', 'sakurairo_csf'),
        'desc' => __(''),
        'default' => '<span style="color: #b9b9b9;"><a href="https://icp.gov.moe/?keyword=20241002" target="_blank">萌ICP备20241002号</a><br><a href="https://github.com/mirai-mamori/Sakurairo" rel="noopener" target="_blank" id="site-info" >Theme Sakurairo</a> <a href="https://github.com/CircleCrop/Sakurairo" rel="noopener" target="_blank" id="site-info-modified" ><i>Modified</i> Version</a>.</span>'
      ),
