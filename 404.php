...
<body <?php body_class(); ?>>
    <section class="error-404 not-found">
        ...
        <div class="err-button back" style="font-family:source han sans,san-serif">
        ...
        <div style="display:block; width:284px;margin: auto;">
            <p style="margin-bottom: 1em;margin-top: 1.5em;text-align: center;font-size: 15px;font-family:source han sans,san-serif"><?php _e('Don\'t worry, search in site?', 'sakurairo');/*别急，试试站内搜索？*/ ?></p>
            <form class="s-search" method="get" action="/" role="search">
                <input class="text-input" style="padding: 8px 20px;font-family:source han sans,san-serif" type="search" name="s" placeholder="<?php _e('Search...', 'sakurairo') ?>" required>
            </form>
        </div>
    </section>
